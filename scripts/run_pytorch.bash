...
gcn_dropout=0.5
gcn_mlp_layers=1
dep_method=gcn  ## none means do not use head features
dep_hidden_dim=200
affix=sd
gcn_adj_directed=1
gcn_adj_selfloop=1
...
for (( d=0; d<${#datasets[@]}; d++  )) do
    dataset=${datasets[$d]}
    logfile=logs/hidden_${hidden}_${dataset}_${affix}_head_${dep_method}_asfeat_elmo_${elmo}_gcn_${gcn_layer}_${gcn_mlp_layers}_${gcn_dropout}.log
    python3.6 main.py --use_elmo ${elmo} --hidden_dim ${hidden} --optimizer ${optim}\
