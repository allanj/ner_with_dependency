...
for (( d=0; d<${#datasets[@]}; d++  )) do
    dataset=${datasets[$d]}
    logfile=logs/hidden_${hidden}_${dataset}_${affix}_head_${dep_method}_asfeat_elmo_${elmo}_gcn_${gcn_layer}_${gcn_mlp_layers}_${gcn_dropout}_dir_${gcn_adj_directed}_loop_${gcn_adj_selfloop}_epoch_${num_epochs}_lr_${lr}.log
