...
gcn_dropout=0.5
gcn_mlp_layers=1
dep_method=lstm_sgcn  ## none means do not use head features
dep_hidden_dim=200
affix=sd
gcn_adj_directed=0
...
for (( d=0; d<${#datasets[@]}; d++  )) do
    dataset=${datasets[$d]}
    logfile=logs/hidden_${hidden}_${dataset}_${affix}_head_${dep_method}_asfeat_${context_emb}_gcn_${gcn_layer}_${gcn_mlp_layers}_${gcn_dropout}_gate_${gcn_gate}_dir_${gcn_adj_directed}_loop_${gcn_adj_selfloop}_epoch_${num_epochs}_lr_${lr}.log
